...
$_['entry_guest_checkout']         = 'Comprar como Visitante:<br /><span class="help">ermitir que os clientes comprem sem possuir um cadastro? Isso não será possível quando um produto para download estiver no carrinho de compras do cliente.</span>';
