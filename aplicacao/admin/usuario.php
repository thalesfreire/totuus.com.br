			...
			<div id="bodyContainer">
				...
				<table cellspacing="0">
					...
					<?php 
						...
						{	
							echo "<tr><td>". $usuario['dsc_nom_usuario']."</td><td>". $usuario['dsc_email_usuario']."</td>
							<td><a href=\"alterarUsuario.php?seqUsuario=".$usuario['seq_usuario']."\">Alterar</a> | 
							<a href=\"javascript:excluirUsuario(".$usuario['seq_usuario'].", '".$usuario['dsc_nom_usuario']."');\">Excluir</a></td></tr>";
						}
				...
				<form>
					<p>
					<input type="button" value="Novo Usuário" onclick="javascript:window.location='novoUsuario.php';"/>
					</p>
				</form>
			</div>
