...
<div id="Outer">
  <div id="Header">
    <div id="Logo"> <a href="index.php"><img src="../../images/LogoTotuus.png" border="0" id="LogoImage" alt="Totuus - Localização e Monitoramento" /></a> </div>
    <br class="Clear" />
  </div>
</div>
<div id="TopMenu">
...
<div class="Content" style="margin-left: 5px;">
  <div id="bodyContainer">
    <div style="width:350px; border-width:1px;border-color:#999999; border-style:solid; margin:auto; margin-top:100px;margin-bottom:100px; text-align:center">
      <?php if(empty($_SESSION["idUsuarioAdmin"])) { ?>
      <h3 style="color:#999999;">Área do Administrador</h3>
      ...
      <?php } else {?>
      <h3 style="color:#999999;">Área do Administrador</h3>
      <div style="color:#999999; font-size:12px; padding-bottom: 10px;" >Usuário Logado:
