...
LabeledMarker.prototype.initialize = function(map) {
  ...
  //this.div_.id = this.labelText_;
  this.div_.innerHTML = "Teste "+this.labelText_;
 
  
  
  
  var divContainerLabeled = this.div_;
  divContainerLabeled.className = "divContainerLabeled";
  divContainerLabeled.innerHTML = "";
  
  
  var divEsquerda = document.createElement("div");
  divEsquerda.innerHTML = "<img src='../follow/img/mobile_marker_tl.png'>";
  divEsquerda.className = "divImagemLabeled"
  
  var divMeio = document.createElement("div");
  divMeio.innerHTML = this.labelText_;
  divMeio.className = "textoLabeled";
  
  var divDireita = document.createElement("div");
  divDireita.innerHTML = "<img src='../follow/img/mobile_marker_tr.png'>";
  divDireita.className = "divImagemLabeledDireita";
  
  
  divContainerLabeled.appendChild(divEsquerda);
  divContainerLabeled.appendChild(divMeio);
  divContainerLabeled.appendChild(divDireita);
  ...
  //map.getPane(G_MAP_MARKER_PANE).appendChild(divContainerLabeled);
  
  //divContainerLabeled.appendChild(divImagemContainerLabeled);
  //divContainerLabeled.appendChild(this.div_);
